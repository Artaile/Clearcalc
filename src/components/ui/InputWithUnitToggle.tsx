        ...
        <div className={cn("flex flex-col gap-2", className)}>
            ...
            <div className="flex gap-4">
                <div className="grid grid-cols-2 bg-black/40 p-1 rounded-2xl border border-white/5 w-[160px] h-14 items-center shrink-0">
                    {toggleOptions.map((option) => (
                        <button
                            ...
                            className={cn(
                                "h-full rounded-xl text-sm font-medium transition-all flex items-center justify-center whitespace-nowrap px-1",
                ...
                <input
                    ...
                    className="flex-1 h-14 rounded-2xl border border-white/10 bg-white/[0.03] px-4 text-xl text-white placeholder:text-zinc-700 outline-none transition-all duration-200 focus:border-white/20 focus:bg-white/[0.05] focus:ring-4 focus:ring-white/5 remove-arrow"
                    {...props}
                />
            </div>
            <style jsx>{`
